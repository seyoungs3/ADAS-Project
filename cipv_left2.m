...
% 박스 위치 설정
box_x = 	[0.3, 0.45, 0.6];  % x 위치 (왼 → 오)
box_y = 0.4;               % y 고정
w = 0.15; h = 0.3;         % width, height
...
% 
% 
% text(0.5, 0.5, num2str(ttc_stage), ...
